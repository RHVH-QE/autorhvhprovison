...
import (
	...
	"github.com/dracher/autorhvhprovison/utils/beaker"
...
func ProvisionHandler(c *gin.Context) {
	...
	if c.BindJSON(&params) == nil {
		provision.ParseKickstarts(params.KsName, params.ImgURL, cfg.IP, cfg.PORT, params.BkrName)
		...
		beaker.NewBeaker(params.BkrName).Reboot()
